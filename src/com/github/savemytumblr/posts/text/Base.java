...
public abstract class Base extends ContentItem {
    ...
    private static final Map<String, Class<? extends com.github.savemytumblr.posts.text.formatting.Base>> formattingTypesMap =
            new HashMap<String, Class<? extends com.github.savemytumblr.posts.text.formatting.Base>>() {
    ...
    private static final Map<String, Class<? extends com.github.savemytumblr.posts.text.Base>> typesMap =
            new HashMap<String, Class<? extends com.github.savemytumblr.posts.text.Base>>() {
				private static final long serialVersionUID = 1L;
			{
    ...
    public static ContentItem doCreate(JSONObject textObject) throws com.github.savemytumblr.exception.RuntimeException {
